...
class HCSR04:
    ...
    def time_to_mm(self, pulse_time):
        cms = (pulse_time / 2) / 29.1
        return cms
    
    def time_to_cm(self, pulse_time):
        mm = pulse_time * 100 // 582
        return mm 
...
if __name__ == "__main__":
    ...
    dist_sens = HCSR04(trigger_pin=12, echo_pin=13)
    
    while 1:
        
        pulse_time = dist_sens._send_pulse_and_wait()
        
        mm = dist_sens.time_to_mm(pulse_time)
        
        cm = dist_sens.time_to_cm(pulse_time)
